...
class AmazonWizard(models.TransientModel):
    ...
    # name = fields.Char()
    logistics_company = fields.Char(string=u'物流公司')
    ...
    def false_delivery(self):
        ...
        for order in sale_orders:
            ...
            for line in order.order_line:
                ...
                </Message>""" % (message_id, AmazonOrderID, FulfillmentDate, self.logistics_company,
                                 order.shipment_service_level_category, self.shipment_number, line.order_item_id,
